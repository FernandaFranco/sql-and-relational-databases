...
--
-- Name: transactions; Type: TABLE; Schema: public; Owner: fernanda
--
...
ALTER TABLE transactions OWNER TO fernanda;

--
-- Name: transactions_id_seq; Type: SEQUENCE; Schema: public; Owner: fernanda
--
...
ALTER TABLE transactions_id_seq OWNER TO fernanda;

--
-- Name: transactions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: fernanda
--
...
--
-- Name: transactions id; Type: DEFAULT; Schema: public; Owner: fernanda
--
...
--
-- Data for Name: transactions; Type: TABLE DATA; Schema: public; Owner: fernanda
--
...
--
-- Name: transactions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: fernanda
--
...
--
-- Name: transactions transactions_pkey; Type: CONSTRAINT; Schema: public; Owner: fernanda
--
